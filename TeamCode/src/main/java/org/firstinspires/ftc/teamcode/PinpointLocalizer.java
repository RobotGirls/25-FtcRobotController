...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2000.7262203629882; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2590.0110968114404; // x position of the perpendicular encoder (in tick units)
    }
